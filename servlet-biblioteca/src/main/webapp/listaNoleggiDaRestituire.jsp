	...
	<table  class="table table-bordered table-striped">
	 <thead>
		...
		<tr>
			...
			<td><form action="utente/restituisci-libro-noleggiato">
				<input type="hidden" name="idLibro" value=<%=lista.getIdLibro()%>>
				<input type="submit" name="submit" value="Restituisci">
			</form></td>
